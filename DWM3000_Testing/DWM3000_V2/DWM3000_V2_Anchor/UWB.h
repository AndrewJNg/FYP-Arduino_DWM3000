...
void UWB_setup() {
  ...
  // SPI.begin();  // Start SPI
  // pinMode(PIN_IRQ, INPUT);  // Set IRQ as input
  // pinMode(PIN_RST, OUTPUT);
  // digitalWrite(PIN_RST, HIGH);  // Ensure reset is inactive
  // SPI.beginTransaction(SPISettings(8000000, MSBFIRST, SPI_MODE0));  // Ensure SPI Mode 0
